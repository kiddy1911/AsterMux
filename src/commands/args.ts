...
import { parseExecutionModeFromRequest } from "../provider/execution-mode.js";
...
export function printHelp(version: string): void {
  console.log(`astermux v${version}`);
  console.log("");
  console.log("Usage:");
  console.log("  astermux [options]");
  console.log("");
  console.log("Commands:");
  console.log(
    "  login [name]              Log into a Cursor account (saved to ~/.astermux/accounts/)",
  );
  console.log(
